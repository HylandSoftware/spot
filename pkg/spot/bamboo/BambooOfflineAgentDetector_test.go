...
func mockBamboo(un, pw string) (*mockBambooServer, *BambooOfflineAgentDetector) {
	m := http.NewServeMux()
...
func TestNewBambooDetectorFromArg_NoCredentials(t *testing.T) {
	sut, err := NewBambooDetectorFromArg("http://foo/")
...
func TestNewBambooDetectorFromArg_WithCredentials(t *testing.T) {
	sut, err := NewBambooDetectorFromArg("http://foo/,un,pw")
...
func TestFindOfflineAgents_Query_BadEndpoint(t *testing.T) {
	sut := NewBambooDetector("://foo", "fizz", "buzz")
